module github.com/google-cloud-tools/kube-eagle/modules
...
require (
	...
	github.com/google-cloud-tools/kube-eagle v0.0.0-20181109145011-39d4c5e49aed
	...
	k8s.io/metrics v0.0.0-20181110193038-6a91c907ff4d
